...
\begin{figure}[!h]
 ...
 \subfigure[time]{
  ...
  \subfigure[inversion accuracy]{
    \resizebox{0.48\textwidth}{!}{\includegraphics{relalpha_l2.eps}}}
...
\caption{Negative logarithm of the relative error in $\nabla\mcL$ between LLGP and the exact computation, over the same grid of kernels as Fig.~\ref{fig:rellog}}\label{fig:relgrad}
\end{figure}
